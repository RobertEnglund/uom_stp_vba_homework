...
- 3 screen shots:  one for each year of the results on the Multi Year Stock Data.
- 2 text files:  one for each macro in the workbook used for homework
	- SummarizeYear:  macro that does the work
	- ResetPage: initialize tabs between runs of SummarizeYear 
